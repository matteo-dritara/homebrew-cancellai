...
- **E21 - Target Engine Trust Remediation** (`in_progress`): Repair the target engine's scan-completeness authority so that unknown state cannot become destructive permission, and make the differential gate capable of proving it.
...
- **E14 - Predictive Guardian Intelligence** (`in_progress`): Detect disk pressure, runaway growth, and structural anomalies using local evidence without acquiring authority.
