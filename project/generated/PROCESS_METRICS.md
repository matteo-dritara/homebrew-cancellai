...
- **87 of 102** story packets past `ready_for_review` carry a row per acceptance criterion.
- Packets that do not:
...
49 of 131 stories are CR3 or CR4, the levels whose gates require
...
- Acceptance criteria describing **unwanted behaviour**: **16 of 374** (4%).
