...
- **Independent reviewer:** 36 of 87 round-1 verdicts were `FAIL` - **41%**.
...
- **124 of 139** story packets past `ready_for_review` carry a row per acceptance criterion.
- Packets that do not:
...
60 of 164 stories are CR3 or CR4, the levels whose gates require
...
- Acceptance criteria describing **unwanted behaviour**: **65 of 511** (13%).
