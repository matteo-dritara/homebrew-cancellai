...
- **85 of 100** story packets past `ready_for_review` carry a row per acceptance criterion.
- Packets that do not:
...
48 of 129 stories are CR3 or CR4, the levels whose gates require
...
- Acceptance criteria describing **unwanted behaviour**: **13 of 366** (4%).
