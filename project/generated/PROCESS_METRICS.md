...
- **84 of 99** story packets past `ready_for_review` carry a row per acceptance criterion.
- Packets that do not:
...
48 of 128 stories are CR3 or CR4, the levels whose gates require
...
- Acceptance criteria describing **unwanted behaviour**: **11 of 362** (3%).
