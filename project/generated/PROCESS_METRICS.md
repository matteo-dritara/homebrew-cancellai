...
- **101 of 116** story packets past `ready_for_review` carry a row per acceptance criterion.
- Packets that do not:
...
56 of 145 stories are CR3 or CR4, the levels whose gates require
...
- Acceptance criteria describing **unwanted behaviour**: **39 of 429** (9%).
