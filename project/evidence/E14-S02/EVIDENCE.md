...
cd rust && cargo test --workspace                                         # PASS - 0 failed (20 new cancellai-guardian::forecast tests, 37 total in the crate)
...
- The outlier trim removes at most one point per fit and only above `MIN_FOR_OUTLIER_TRIM` (5)
  ...
  third simultaneous outlier above the trim floor is not separately exercised.
